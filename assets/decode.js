...
function decode(text){
    ...
    var baseTimeS = extractNum(data, 4);
    output.baseTime = new Date(baseTimeS * 1000);
    ...
    output.timeSesReceived = timeSesReceivedS == 0 ? null : new Date(timeSesReceivedS * 1000);
    var timeInreachSentS = extractNum(data, 4);
    output.timeInreachSent = timeInreachSentS == 0 ? null : new Date(timeInreachSentS * 1000);

    return output;
}
var example = "uulBZRYlAgQBACwEBARFAAQIADYEAAQ0AAQVABYE4wMrACUKABME4AMdACUpXI8/VQFmZoY/XwCy4EBlu+lBZQ==";
console.log("input", example)
console.log("output", decode(example))
